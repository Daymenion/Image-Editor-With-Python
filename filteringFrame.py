...
class FilteringFrame(Toplevel):
    def __init__(self, master=None):
        ...
        self.negativePic_button = Button(master=self, text="Photo Negative")
        ...
        self.negativePic_button.bind("<ButtonRelease>", self.negativePic_button_released)
    ...
    def negativePic_button_released(self, event):
        self.negativePic()
        self.show_image()
    ...
    def show_image(self):
        self.master.interface_functions.show_image(img=self.filtered_image)
