...
class EdgeDetectionFrame(Toplevel):
    def __init__(self, master=None):
        ...
        self.thresholdParam_scale = Scale(self, from_=40, to_=255, length=300, resolution=0.1, activebackground="gray",
    ...
    def show_image(self):
        self.master.interface_functions.show_image(img=self.images)
